...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.tintColor = [UIColor pumpkin];
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor pumpkin]}];
